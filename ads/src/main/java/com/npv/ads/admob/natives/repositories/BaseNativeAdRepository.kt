...
abstract class BaseNativeAdRepository<T>(
    private val nativeAdConditions: NativeAdCondition,
    private val adsSharedPref: IAdsSharedPref,
    private val defaultSettingProvider: com.npv.ads.admob.natives.provider.IDefaultNativeSettingsProvider,
    private val revenueTracker: RevenueTrackerManager
) : com.npv.ads.admob.natives.repositories.NativeAdRepository {
    private var nativeDisplaySettingsMap = mapOf<String, com.npv.ads.admob.natives.models.NativeDisplaySetting>()
    private val natives = ArrayList<T>()
    private var isLoading = false
    private var numberFailedLoad = 0
    private var timeLastFailedLoad = 0L
    private var listeners: ArrayList<com.npv.ads.admob.natives.listeners.NativeAdChangedListener> = ArrayList()
    ...
    private fun loadLastConfig() {
        ...
        try {
            val nativeAdSetting =
                Gson().fromJson(json, com.npv.ads.admob.natives.models.NativeSetting::class.java)
    ...
    override fun addListener(ls: com.npv.ads.admob.natives.listeners.NativeAdChangedListener) {
        listeners.add(ls)
    }

    override fun removeListener(ls: com.npv.ads.admob.natives.listeners.NativeAdChangedListener) {
        listeners.remove(ls)
    }
    ...
    override fun getNativeDisplaySetting(id: String): com.npv.ads.admob.natives.models.NativeDisplaySetting? {
        loadLastConfig()
